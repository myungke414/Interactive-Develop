  ...
  /* 생성자 */
    constructor() {
        ...
        */
        ...
        /*
        requestAnimationFrame은 css로 처리하기 어려운 애니메이션이지만 
        Canvas, SVG 등의 애니메이션 구현에 이용하는 함수 setInterval과 흡사하다. 
        하지만 재귀적으로 자신을 호출한다는 점이 다르다.
        1초당 디스플레이 주사율에 따라 정해진 프레임을 렌더링해준다.
